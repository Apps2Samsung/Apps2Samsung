...
|------------|---------------------------------------------------------------------|------------------------------|
| **Stable** | [v2.5.4](https://github.com/Apps2Samsung/Apps2Samsung/releases/tag/v2.5.4)                                        | Recommended for most users   |
| **Beta**   | [v2.5.5-beta](https://github.com/Apps2Samsung/Apps2Samsung/releases/tag/v2.5.5-beta)                                            | Includes new features        |
