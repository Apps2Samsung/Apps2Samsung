...
/// <summary>
/// A selectable "app/release" in the catalog. Ported from the desktop model so the mobile
/// App/Version dropdowns mirror the desktop's two-tier Release → Version selection.
/// </summary>
...
/// <summary>A downloadable version (a .wgt/.tpk asset of a release).</summary>
public sealed class Asset
{
	[JsonPropertyName("name")] public string FileName { get; set; } = string.Empty;
